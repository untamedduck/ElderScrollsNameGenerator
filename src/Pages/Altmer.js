    ...
    useEffect(() => {
        ...
        return (
            ...
            self-center h-auto lg:pl-16 w-full lg:w-1/2 mt-16 lg:mt-0 p-4">
                        <h1 className="justify-center text-3xl md:text-3xl lg:text-4xl font-bold text-lg w-3/4 text-[#d7b15b]"> High
                            Elf Character Name Generator</h1>
                        <p className="pt-6  text-base md:text-lg lg:text-lg"> Altmer are the light-skinned and tall
                            Elves of the Summerset Isles. In the Empire, the name
                            "High Elves" is given to the Altmer,
                            with the word "High" being used to describe the Altmer as tall, proud, and culturally
                            snobbish. The Altmer consider themselves the perfect race.
                ...
                <div className="flex w-full relative z-0 justify-center lg:w-auto flex-wrap">
                    <div className="grid max-h-24 w-auto relative z-0 justify-center lg:w-auto mt-4">
                        ...
                        rounded font-Rubik lg:w-56 h-14 w-full hover:bg-[#ded2ae] transform transition duration-500 hover:scale-105 "> Generate
                            names
                        </button>
                        <div className="mt-4">
            ...
            self-center w-full lg:pl-16 lg:w-1/2 mt-4 lg:mt-0 lg:p-4">
                        <div
                            className="justify-center md:text-3xl lg:text-2xl font-bold text-lg text-[#] w-auto pl-4 lg:pl-0">{names.map((name, i) => (
                            <div className="mb-2" key={i}>{name}</div>))}</div>
